...
static int OpeningExchangePenalty = 30; // Thomas penalty exchange piece pawn
static int EndgameExchangePenalty = 30;

static int MaterialWeight = 256;

static const int PawnOpening   = 80;
